...
//   return res(ctx.status(200), ctx.json({ message: "You are now registered" }));
// });
...
//   const newUser = req.body as IUser | undefined;
...
//   return res(
//     ctx.status(200),
//     ctx.json({ message: "You are now registered", user: registeredUser })
//   );
// });
